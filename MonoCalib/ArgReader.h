    ...
    private:
        ...
        inline static string GetParamKeys() 
        {
            const char * keys = 
                ...
                "{ input          | Input/Camera_0_Intrinsic.txt    | The folder containing the input files        }"
                "{ output         | Output/Calibration.xml          | The folder containing the output files       }";
