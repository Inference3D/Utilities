...
namespace NVL_Utils 
{
    ...
    public:
        ...
        inline static NVLib::Parameters * GetParameters(int argc, char ** argv) 
        {
            ...
            parser.about("SemiStereo v1.0.0");
            ...
            parameters->Add("index_1", parser.get<String>("index_1"));
            parameters->Add("index_2", parser.get<String>("index_2"));
    ...
    private:
        ...
        inline static string GetParamKeys() 
        {
            const char * keys = 
                ...
                "{ index_1        | 21                    | The index of the first image                 }"
                "{ index_2        | 10                    | The index of the second image                }"; 
